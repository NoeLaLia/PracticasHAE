...
;p4a.c,18 :: 		void interrupt(){
;p4a.c,19 :: 		char letra = tecla();
	CALL        _tecla+0, 0
;p4a.c,20 :: 		x = PORTB;
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;p4a.c,21 :: 		INTCON.RBIF = 0;
	BCF         INTCON+0, 0 
;p4a.c,23 :: 		Lcd_Chr(1, 1, letra);
	MOVLW       1
...
;p4a.c,30 :: 		PORTB = 0;
	CLRF        PORTB+0 
;p4a.c,33 :: 		INTCON2.RBPU = 0;
	BCF         INTCON2+0, 7 
;p4a.c,34 :: 		x = PORTB;
	MOVF        PORTB+0, 0 
	MOVWF       _x+0 
;p4a.c,35 :: 		INTCON.RBIF = 0; //Reiniciamos el flag por si acaso
	BCF         INTCON+0, 0 
;p4a.c,36 :: 		INTCON.RBIE = 1;//Activamos la interrupción
	BSF         INTCON+0, 3 
;p4a.c,37 :: 		INTCON.GIE = 1; //Activamos las interrupciones globalmente
	BSF         INTCON+0, 7 
;p4a.c,38 :: 		Lcd_Init();
	CALL        _Lcd_Init+0, 0
;p4a.c,40 :: 		while(1){}
